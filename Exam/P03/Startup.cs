    ...
    class Startup
    {
        public static void Main()
        {
            ...
            if (minutes > 0 && minutes <= 10)
            {
                ...
                if (minutes % 2 == 0)
                {
                    Console.WriteLine($"{playersName} was injured after the penalty.");
                }
            }
            else if (minutes > 10 && minutes <= 35)
            {
                ...
                if (minutes % 2 != 0)
                {
                    Console.WriteLine($"{playersName} got another yellow card.");
                }
            }
            ...
            else if (minutes > 55 && minutes <= 80)
            {
                ...
                if (minutes % 2 != 0)
                {
                    Console.WriteLine($"{playersName} has been changed with another player.");
                }
            }
